...
class GPT2Model(GPTPreTrainedModel):
  ...
  def encode(self, hidden_states, attention_mask, prefix_key_values=None):
    """
    hidden_states: [batch_size, seq_len, hidden_size]
    attention_mask: [batch_size, seq_len]
    prefix_key_values:
      None 또는 길이 num_hidden_layers의 list/tuple
      각 원소는 (prefix_key, prefix_value)
    """
  ...
  def forward(self, input_ids, attention_mask, prefix_key_values=None):
    """
